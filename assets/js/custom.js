jQuery(document).on('click', 'a.display-staff', function(){
    ...
    jQuery.ajax({
        type:'POST',
        url:baseurl+'index.php/staff/display',
...
jQuery(document).on('click', 'a.update-staff-details', function(){
    ...
    jQuery.ajax({
        type:'POST',
        url:baseurl+'index.php/staff/edit',
        data:{staff_id: staff_id},
        dataType:'html',    
        beforeSend: function () {
...
jQuery(document).on('click', 'button#delete-staff', function(){
    ...
    jQuery.ajax({
        type:'POST',
        url:baseurl+'index.php/staff/delete',
        data:{staff_id: staff_id},
        dataType:'html',  
        success: function (html) {
...
jQuery(document).on('click', 'button#add-staff', function(){
    jQuery.ajax({
        type:'POST',
        url:baseurl+'index.php/staff/save',
...
jQuery(document).on('click', 'button#update-staff', function(){
    jQuery.ajax({
        type:'POST',
        url:baseurl+'index.php/staff/update',
