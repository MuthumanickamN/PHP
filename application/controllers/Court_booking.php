...
//                            }
    ...
    public function get_events($activity_id, $location_id, $parent_id){
        ...
        where ba.`customerid` ='".$parent_id."' and bs.`sid` ='".$activity_id."' and bs.lid='".$location_id."' and ba.bstatus=1 and bs.cancelled = 0 and bs.booked_date BETWEEN '".$start."' AND '".$end."' and (ba.`blocked_status` = 1) ");
        ...
        where tb.`parent_id` ='".$parent_id."' and tb.`activity_id` ='".$activity_id."' and tb.location_id='".$location_id."' and tb.`checkout_date` BETWEEN '".$start."' AND '".$end."' ");
