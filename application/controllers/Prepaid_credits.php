...
class Prepaid_credits extends CI_Controller {  	
	...
	public function index(){
		...
		$data['locationListing'] = $locationListing;
...
$email=$this->session->userdata('username');
	...
	$user_name=$postData1['user_name'];
		...
		$updated_at=currentDateTime();
		 ...
		 $sql="Update  prepaid_credits set location_id='$location_id',parent_id='$parent_id',name_id='$parent_name',mobile_id='$parent_mobile',balance_credits='$balance_credits',total_credits='$total_credits',amount_paid='$paid_amount',location_id='$location_id',description='$description',payment_type='$payment_type',bank='$bank',cheque_number='$cheque_no',cheque_date='$cheque_date',updated_at='$updated_at' where id='$id'";
		$insert=$this->db->query($sql);
...
public function list_(){
	...
	foreach ($data['creditList'] as $key => $value) {
        ...
        $data['creditList'][$key]['location_id'] = $this->transaction->getLocationDetail($value['location_id']);
