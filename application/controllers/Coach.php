	...
	public function add(){
		...
		if (empty($json['error']) ) {
			...
			if($coach_id !=''){
				...
				$sql="Update  coach set coach_name='$coach_name',age='$age',dob='$dob',gender='$gender',experience='$experience',role='$role',activity_id='$activity_id',location_id='$location_id',address='$address',address1='$address1',city='$city',state='$state',country='$country',postal_code='$postal_code',phone1='$phone1',phone2='$phone2',email_id='$email_id',emirates_id='$emirates_id',expiry_date='$expiry_date',status='$status',passport_size_image='$passport_size_image',passport_image='$passport_image',visa_image='$visa_image',emirates_id_image='$emirates_id_image',experience_certificate_image='$experience_certificate',police_verification_image='$police_verification_image',municipality_certificate_image='$municipality_certificate_image',updated_at='$updated_at' where coach_id='$coach_id'";
