...
<div class="modal fade rotate" id="dispaly-school" style="display:none;">
    <div class="modal-dialog"> 
        <form id="display-staff-form" method="post">   
            <div class="modal-content panel panel-primary">
                <div class="modal-header panel-heading">
                    <h4 class="modal-title -remove-title">School Profile</h4>
