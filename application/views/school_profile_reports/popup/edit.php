...
<div class="modal fade rotate" id="update-school" style="display:none;">
    <div class="modal-dialog modal-lg"> 
        <form id="update-school-form" method="post">   
            <div class="modal-content panel panel-primary">
                <div class="modal-header panel-heading">
                    <h4 class="modal-title -remove-title">EDIT SCHOOL REGISTRATION</h4>
