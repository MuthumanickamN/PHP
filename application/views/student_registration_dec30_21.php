      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li><a href="<?php echo site_url('Students/list'); ?>" class="btn btn-primary"   ><b>Student List</b></a></li>
          </ul>
        ...
        <div class="col-sm-12">
          ...
          <form id="registrationForm" class="form-horizontal" method="POST" style="margin-top: 25px; margin-left: 5px; margin-right: 5px" enctype="multipart/form-data">
            <input type="hidden" name="id" id="id" value="<?php if(isset($id)){echo $id;}?>">
                        ...
                        <input type="text" id="student_name" name="student_name"  oninput="allLetter(document.form.student_name)" class="form-control" value="<?php echo $name; ?>">
                      ...
                      <div id="result"  <?php if($role == 'parent') echo "style='display:none;' "?> >
                        </div> 
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                         <td>Balance <?php echo isset($balance)?number_format((float)$balance, 2, '.', ''):'0.00';?> AED</td>
                          ...
                          <td colspan="6"></td>
                          <td style="text-align: center;"><button type="button" id="transactionHistoryBtn" class="btn btn-info" onClick="show_transaction();">Transaction History</button></td>
            ...
            <tbody>
               <?php                      
                  foreach ($activitylists as $key => $row1) { ?>
                    ...
                    <td style="text-align: center"><a type="button" style="color:white;text-decoration:none;" class="btn btn-success fa fa-calendar-check-o"  href="<?php echo base_url('Student_profile_slot_booking/book/'.$row1['activity_id'].'/'.$id )?>">
                        </a></td>
          ...
          if (json['error']) {             
			 ...
			 //  $("#loading_image").hide();
              if(json['status'] == 'success'){
                ...
                window.location.href = baseurl+'Students/list';
          }
