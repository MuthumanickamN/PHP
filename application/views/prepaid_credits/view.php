      ...
      <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Prepaid Credits</a>
                  </li>
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/Prepaid_credits/list_'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Prepaid Credits Details</h4>
                ...
                <tr>
                  ...
                  <th class="text-left">Mobile Number</th>
                   <td class="text-left"><?php echo $mobile_id; ?></td>           </tr>
                     <tr>
                  <th class="text-left">Amount Paid (AED)</th>
                   <td class="text-left"><?php echo $amount_paid; ?>.00</td>           </tr>
                     <tr>
