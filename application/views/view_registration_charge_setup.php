      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/registration_charge_setup'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Registration Charge Setup Details</h4>
              ...
              <thead>
                <tr>
                  <th class="text-center">ID</th>
                   ...
                   <th class="text-center">Registration Fees (AED)</th>
