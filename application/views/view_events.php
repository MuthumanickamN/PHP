      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/events'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
         ...
         <div class="table-responsive">
            <table class="table mb-0">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"> <?php echo date("d-m-Y", strtotime("$event_date")); ?></td>
                  <td class="text-center"><?php echo $event_name;?></td>
                    <td class="text-center"><?php echo $event_place;?></td>
                     <td class="text-center"><?php echo $event_detail;?></td>
