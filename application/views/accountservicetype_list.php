...
<script type="text/javascript">
 ...
 function view_accountservicetype(Id)
{
    window.location='<?php echo site_url('accountservicetype/view/'); ?>'+Id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/accountservicetype/add/'); ?>" class="btn btn-primary"   ><b>New Account Service Type</b></a></li>
          </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">AccountServiceType List</h4>
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                <thead>
                                    <tr>
                                            ...
                                            <th style="text-align: center">Account_code</th>
								...
								<?php   
								$i=1;                     
								$osql1 = "select * from accounts_service ORDER BY id DESC"; 
								...
								<tr>
									...
									<td style="text-align: center"><?php echo $row1['Account_code']; ?></td>
									<td style="text-align: center"><?php echo $row1['Type']; ?></td>

									<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/accountservicetype/edit/'.$row1['Id']); ?>">
									</a>
									</td>

									<td style="text-align: center">
									<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/accountservicetype/delete/'.$row1['Id']); ?>">
									</a>
									</td>
								</tr>
								<?php  $i++; } ?>
