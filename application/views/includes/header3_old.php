...
<script type="text/javascript" src="<?php echo base_url() . 'js/bootstrap.js' ?>"></script>-->
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-validate.bootstrap-tooltip.js"></script> 
      ...
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-television"></i><span data-i18n="Templates">Academy Activites</span></a>
          <ul class="dropdown-menu">
            <?php if (show_model_in_menu('coach_registration', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('student_registration', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('registration_fees', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Daily_transaction', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Activity_remark', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Attendance_book', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Slot_refund_approval', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Slot_refund_request', $menu_model)) : ?>
              <li data-menu="Slot_refund_request"><a class="dropdown-item" data-toggle="" href="<?php echo base_url() . 'Slot_refund_request' ?>"><span data-i18n="Daily Fees">Slot Refund Request</span></a></li>
            <?php endif; ?>
            <?php if (show_model_in_menu('Prepaid_credits', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('User_wallet_details', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Registration_approval', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Activity_approval', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Credits_roll_back', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Booking_approval', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Wallet_transaction', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Bulk_refund', $menu_model)) : ?>
            ...
            <?php endif; ?>
            <?php if (show_model_in_menu('Contract_customer_invoice', $menu_model)) : ?>
        ...
        <?php if (show_model_in_menu('student_profile_slot_booking', $menu_model)) : ?>
          <li class="dropdown nav-item">
            <a class="dropdown-toggle nav-link" href="<?php echo base_url() . 'student_profile_slot_booking' ?>" id="a2">
              <i class="fa fa-cogs hidden"></i>
              <span data-i18n="Student Profile / Slot Booking">Student Profile / Slot Booking</span></a>
          </li>
        <?php endif; ?>

        <?php if (show_model_in_menu('MaintenanceMenu', $menu_model)) : ?>
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-cogs"></i><span data-i18n="Apps">Maintenance</span></a>
            <ul class="dropdown-menu">
              ...
              <?php if (show_model_in_menu('activity', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('location', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('activity_based_location', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('lane_court', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('activity_level', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('activity_slot', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('registration_charge_setup', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('fees_package_setup', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('bank_details', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('discount_setup', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('account_codes', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('events', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('scroll_text_messages', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('set_academy_holiday', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('vat_setup', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('refund_discount_percentages', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('fees_structure_images', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('assign_coach', $menu_model)) : ?>
        ...
        <?php if (show_model_in_menu('ReportsMenu', $menu_model)) : ?>
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-list"></i><span data-i18n="Pages">Reports</span></a>
            <ul class="dropdown-menu">
              <?php if (show_model_in_menu('daily_activity_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Coach_roaster', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('student_profile_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('coach_profile_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('daily_transaction_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Ledger_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('attendance_tracking_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Request_approve_reject_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Master_wallet_transaction_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Wallet_transaction_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Activity_list_Report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Slot_schedule_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('activity_slot_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Invoice_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('vat_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Contract_payment_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Slot_swap_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Rating_review_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Class_booked_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Class_attended_report', $menu_model)) : ?>
              ...
              <?php endif; ?>
              <?php if (show_model_in_menu('Class_missed_report', $menu_model)) : ?>
        ...
        <?php if (show_model_in_menu('SchoolMenu', $menu_model)) : ?>
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-institution"></i><span data-i18n="Layouts">School</span></a>
            <ul class="dropdown-menu">
              ...
              <?php if (show_model_in_menu('school_profile_report', $menu_model)) : ?>
        ...
        <?php if (show_model_in_menu('UserMenu', $menu_model)) : ?>
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-user"></i><span data-i18n="UI">User</span></a>
            <ul class="dropdown-menu">
              <?php if (show_model_in_menu('users', $menu_model)) : ?>
                ...
                <li data-menu="games"><a class="dropdown-item" data-toggle="" href="<?php echo base_url() . 'users?role=superadmin' ?>"><span data-i18n="Activity">Super Admin</span></a></li>
                <li data-menu="games"><a class="dropdown-item" data-toggle="" href="<?php echo base_url() . 'users?role=admin' ?>"><span data-i18n="Activity">Admin</span></a></li>
              <?php } if($role == 'coach' ||  $role == 'superadmin' || $role == 'admin') { ?>
                <li data-menu="games"><a class="dropdown-item" data-toggle="" href="<?php echo base_url() . 'users?role=coach' ?>"><span data-i18n="Activity">Coach</span></a></li>
              <?php } if($role == 'headcoach' ||  $role == 'superadmin' || $role == 'admin') { ?>
                <li data-menu="games"><a class="dropdown-item" data-toggle="" href="<?php echo base_url() . 'users?role=headcoach' ?>"><span data-i18n="Activity">Head Coach</span></a></li>
              <?php } if($role == 'parent' ||  $role == 'superadmin' || $role == 'admin') { ?>
