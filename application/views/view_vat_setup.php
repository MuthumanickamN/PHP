      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('vat_setup'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">VAT Setup Details</h4>
              ...
              <thead>
                <tr>
                  <th class="text-center">ID</th>
                   ...
                   <th class="text-center">Tax Pdf Doc</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $tax;?></td>
                    ...
                    <td class="text-center"><?php echo $vat_no;?></td>
                  ...
                  <td class="text-center"><?php echo date("d-m-y-h-i-s", strtotime("$created_at")); ?></td>
                   <td class="text-center"><?php if($updated_at=='0000-00-00 00:00:00') { echo '-'; } else  { echo date("d-m-y-h-i-s", strtotime("$updated_at")); } ?></td>
                    <td class="text-left">
                        <?php if($vat_pdf){ ?>
                                        <a href="<?php echo base_url().$vat_pdf;?>">
                    <img src="<?php echo base_url().$vat_pdf;?>" style="width:20px; height:20px;  vertical-align: middle">View here</a>
                    <?php } else { echo '-'; } ?>
                                      </td>
                </tr>
