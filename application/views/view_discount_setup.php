      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/discount_setup'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Discount Setup Details</h4>
            ...
            <table class="table mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $discount_name;?></td>
                    <td class="text-center"><?php echo $discount_percentage;?></td>
