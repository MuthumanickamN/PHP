                                  ...
                                  <div class="modal-dialog" style="width: 100%;
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="alert alert-info">
                                              ...
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: black" onClick="$('#contractform<?php echo $row1['id'];?>').hide();">&times;<span class="close-x">Close</span></button>
