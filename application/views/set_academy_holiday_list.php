...
<script type="text/javascript">
 ...
 function view_holiday(id)
{
    window.location='<?php echo site_url('set_academy_holiday/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Set Academy Holiday</a>
                  </li>
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('set_academy_holiday/add/'); ?>" class="btn btn-primary"   ><b>New Holiday</b></a></li>
          </ul>
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
								...
								<?php        
									$i=1;                
									$osql1 = "select * from set_academy_holidays ORDER BY id DESC"; 
								...
								?>
								<tr>
									<td style="text-align: center"><span style="display:none;"><?php echo strtotime($row1['select_date']); ?></span><?php echo date("d/m/Y",strtotime($row1['select_date'])); ?></td>
									...
									<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/set_academy_holiday/edit/'.$row1['id']); ?>">
									</a>
									</td>

									<td style="text-align: center">
									<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/set_academy_holiday/delete/'.$row1['id']); ?>">
									</a>
									</td>
								</tr>
								<?php $i++;  } ?>
