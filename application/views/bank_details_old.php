      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li><a href="<?php echo site_url('index.php/bank_details'); ?>" class="btn btn-primary"   ><b>Bank List</b></a></li>
          </ul>
        ...
        <div class="col-sm-12">
          ...
          <form id="loginForm" class="form-horizontal" role="form" name="form" method="POST" style="margin-top: 25px; margin-left: 5px; margin-right: 5px">
            <div class="form-group lg">
                        ...
                        <input type="text" id="bank_name" name="bank_name" required="" oninput="allLetter(document.form.bank_name); limit()" class="form-control" value="<?php echo $bank_name; ?>">
                        </div>
                    </div>
                    <div class="form-group lg">
                        <div class="col-md-3 control text-left"><strong>Bank Location</strong>*</div>
                        <div class="col-md-3 control text-left">     
                         <input type="text" id="bank_location" name="bank_location" required="" class="form-control" value="<?php echo $bank_location; ?>" oninput="allLetters(document.form.bank_location); limits()">
                        </div>
                    </div>
                     ...
                     <div class="form-group lg-btm">
                      <div class="col-md-6 control text-center">
                         ...
                         <input id="save" type="submit" name="submit" value="Submit" onclick="<?php echo base_url('index.php/bank_details/add/'); ?>"       class="btn btn-success" /> 
                       <?php } else { ?>
                          
                                     <input id="save" type="submit" name="submit" value="Update" onclick="<?php echo base_url('index.php/bank_details/add/'); ?>"       class="btn btn-success" /><?php } ?>

                        
                        
                         <a href="<?php echo base_url().'index.php/bank_details' ?>"     class="btn btn-danger" >Cancel</a></div></div>
