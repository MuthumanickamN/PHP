                    ...
                    <div class="form-group lg">
                     ...
                     <div class="form-group lg-btm">
                      <div class="col-md-6 control text-center">
                         ...
                         <input id="save" type="submit" name="submit" value="Submit" onclick="<?php echo base_url('index.php/discount_setup/add/'); ?>"       class="btn btn-success" /> 
                       <?php } else { ?>
                          
                                     <input id="save" type="submit" name="submit" value="Update" onclick="<?php echo base_url('index.php/discount_setup/add/'); ?>"       class="btn btn-success" /><?php } ?>

                                 

                        
                         <a href="<?php echo base_url().'index.php/discount_setup' ?>"     class="btn btn-danger" >Cancel</a></div></div>
