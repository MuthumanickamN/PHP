		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="#" class="logo">
					...
					<span class="logo-mini"><img src="<?php echo base_url(); ?>assets_booking/images/favicon.jpg" alt="" /></span>
					<!-- logo for regular state and mobile devices -->
					<span class="logo-lg"><img src="<?php echo base_url(); ?>assets_booking/images/logo.jpg" class="img-responsive" alt="" /></span>
				</a>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user user-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									<img src="<?php echo base_url(); ?>assets_booking/images/user_image.jpg" class="user-image" alt="User Image">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-header">
										<img src="<?php echo base_url(); ?>assets_booking/images/user_image.jpg" class="img-circle" alt="User Image">
										<p>
											Admin Name
										</p>
									</li>
