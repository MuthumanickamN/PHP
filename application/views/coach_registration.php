  ...
  var add_from = "<?php echo $add_from;?>";
  	$(document).ready(function() {
  	    ...
  	    if(add_from)
  	    {
  	        if(add_from == "coach")
  	        {
  	            $('input[name="role"][value="coach"]').prop('checked', true);
  	        }
  	        else if(add_from == "headcoach")
  	        {
  	            $('input[name="role"][value="headcoach"]').prop('checked', true);
  	        }
    ...
    <div class="card">
      ...
      <div class="card-content collapse show">
          <div class="card-body card-dashboard">
            ...
            <form id="coachForm" class="form-horizontal" role="form" name="form" method="POST" style="margin-top: 25px; margin-left: 5px; margin-right: 5px" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-3 control text-left"> <strong>Name</strong>*</div>
                <div class="col-md-3">
                <input type="text" id="coach_name" name="coach_name"   class="form-control" value="<?php if(isset($coach_name)){ echo $coach_name; } ?>">
              ...
              <?php if($coach_id){ ?>
              <div class="row">  
              <div class="col-md-3 control text-left"> <strong>Coach ID</strong> </div>
              <div class="col-md-3">
                <input type="text" id="hid_coach_id" name="hi_coach_id"   class="form-control" value="<?php if(isset($code)){ echo $code; } ?>" readonly>
                <span class="errorMsg"></span>
              </div>
              </div>
            ...
            <div class="row">  
              ...
              <div class="row">  
              <div class="col-md-3 control text-left"><strong>Year of Experience</strong>*</div>
              <div class="col-md-3">
                <input type="text" id="experience" name="experience" class="form-control" value="<?php if(isset($experience)){ echo $experience; } ?>" >
                <span class="errorMsg"></span>
              </div>
          </div>
           ...
           <div class="row">
              ...
              <div class="col-md-3">
              <input id="role" type="radio" value="coach" name="role" <?php if (isset($role) && ($role=='coach')){ echo 'checked';} ?>/>
                <label style="margin-left: 10px; margin-right: 10px" >Coach</label>
                <input id="role" type="radio" value="headcoach" name="role" <?php if(isset($role) && $role=='headcoach'){ echo 'checked';} ?>/>
                <label style="margin-left: 10px; margin-right: 10px">Head Coach</label>
