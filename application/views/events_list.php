 ...
 function view_events(id)
{
    ...
    window.location='<?php echo site_url('index.php/events/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/events/add/'); ?>" class="btn btn-primary"   ><b>New Events</b></a></li>
          </ul>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                ...
                                <tbody>
									<?php         
									$i=1;              
									$osql1 = "select * from events ORDER BY id DESC"; 
									...
									?>
									<tr>
									<td style="text-align: center"><?php echo date("d-m-Y", strtotime("$event_date")); ?></td>
									<td><?php echo $row1['event_name']; ?></td>
									<td><?php echo $row1['event_place']; ?></td>
									<td><?php echo $row1['event_detail']; ?></td>
									...
									<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/events/edit/'.$row1['id']); ?>">
									</a>
									</td>
									<td style="text-align: center">
									<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/events/delete/'.$row1['id']); ?>">
									</a>
									</td>
									</tr>
									<?php  $i++; } ?>
