...
<script type="text/javascript">
 ...
 function view_student(id){
    window.location='<?php echo site_url('Students/view/'); ?>'+id; 
}
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('Students'); ?>" class="btn btn-primary"   ><b>New Student</b></a></li>
          </ul>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
    ...
    <tbody>
        ...
        <td style="text-align: center"><span style="display:none"><?php echo strtotime("$dob");?></span><?php echo date("d/m/Y", strtotime("$dob"));  ?></td>
        ...
        <td style="text-align: center"><?php echo $studList['school_name']; ?></td>
        <td style="text-align: center"><?php echo $studList['parent_code']; ?></td>
        <td style="text-align: center"><?php echo $studList['parent_name']; ?></td>
        ...
        <td style="text-align: center"><span style="display:none"><?php echo strtotime("$issue");?></span><?php echo date("d-m-Y", strtotime("$issue"));  ?></td>    
        <td style="text-align: center;"><span style="display:none"><?php if($expiry!='') { echo strtotime("$expiry"); }?></span><?php if($expiry=='') { echo '-'; } else  {  echo date("d-m-Y", strtotime("$expiry")); }?></td>    
        ...
        <td style="text-align: center">
            <?php $image1=$studList['image_file_name']; 
                if($image1 != ''){ ?> 
                <a href="<?php echo base_url().'assets/'.$studList['image_file_name']; ?>">
                <img src="<?php echo base_url().'assets/'.$studList['image_file_name']; ?>" style="width:20px; height:20px;  vertical-align: middle"/>View here
                </a>
            <?php } else{ echo "--"; }?>
        </td>
        <td style="text-align: center"><?php echo $studList['emirates_id']; ?></td>
        <td style="text-align: center">
            <?php $image2=$studList['student_passport_file_name']; 
                if($image2 != ''){?> 
                <a href="<?php echo base_url().'assets/'.$studList['student_passport_file_name']; ?>">
                <img src="<?php echo base_url().'assets/'.$studList['student_passport_file_name']; ?>" style="width:20px; height:20px;  vertical-align: middle"/>View here
                </a>
            <?php } else{ echo "--"; }?>
        </td>
        <td style="text-align: center">
            <?php $image3=$studList['student_visapage_file_name'];  
                if($image3 != ''){?> 
                <a href="<?php echo base_url().'assets/'.$studList['student_visapage_file_name']; ?>">
                <img src="<?php echo base_url().'assets/'.$studList['student_visapage_file_name']; ?>" style="width:20px; height:20px;  vertical-align: middle"/>View here
                </a>
            <?php } else{ echo "--"; }?>
            </td>    
        <td style="text-align: center"><?php echo $studList['emirates_id']; ?></td>
        <td style="text-align: center">
            ...
            if($image4 != ''){ ?> 
                <a href="<?php echo base_url().'assets/'.$studList['sponsor_passport_file_name']; ?>">
                <img src="<?php  echo base_url().'assets/'.$studList['sponsor_passport_file_name'];  ?>" style="width:20px; height:20px;  vertical-align: middle"/>View here</a>
            <?php } else{ echo "--"; }?>
        </td>
        <td style="text-align: center">
            <?php $image5=$studList['sponsor_visapage_file_name']; 
            if($image5 != ''){ ?> 
                <a href="<?php echo base_url().'assets/'.$studList['sponsor_visapage_file_name']; ?>">
                <img src="<?php echo base_url().'assets/'.$studList['sponsor_visapage_file_name']; ?>" style="width:20px; height:20px;  vertical-align: middle"/>View here
                </a>
            <?php } else{ echo "--"; }?>
            </td>    -->
        <td style="text-align: center">
        ...
        <td style="text-align: center">
            <?php if($studList['approval_status'] == 'Pending'){?>
                <label style="padding: 2px 8px; " class="btn-warning"><?php echo $studList['approval_status'];?></label>
                <?php }else { ?>
        ...
        <td align="center">
            ...
            <a type="button" style="color:white;text-decoration:none;" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('Students/edit/'.$studList['id']); ?>">
            </a>
            <?php if($role == 'superadmin') {?>
            <a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('Students/delete/'.$studList['id']); ?>">
            </a>
            <?php } ?>
        </td>    
        </tr>
