 ...
 function view_bank(id)
{
    ...
    window.location='<?php echo site_url('index.php/bank_details/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/bank_details/add/'); ?>" class="btn btn-primary"   ><b>New Bank</b></a></li>
          </ul>
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
							...
							<tr>
								...
								<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/bank_details/edit/'.$row1['id']); ?>">
								</a>
								</td>
								<td style="text-align: center">
								<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/bank_details/delete/'.$row1['id']); ?>">
								</a>
								</td>
							</tr>
							<?php $i++; } ?>
