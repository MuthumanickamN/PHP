      ...
      <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Refund Discount Percentgae</a>
                  </li>
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/refund_discount_percentages'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Refund Discount Percentage Details</h4>
