      ...
      <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Location Based Activity</a>
                  </li>
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/location_based_games'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Location Based Activity Details</h4>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center">   <?php
                        $osql2 = "select * from games where game_id=".$game_id;                              
                            $oexe2 = mysqli_query( $con, $osql2 );
                            $row2 = mysqli_fetch_assoc( $oexe2 );

                         echo $row2['game']; ?></td>
                  <td class="text-center"> <?php 
                        $osql1 = "select * from locations where location_id=".$location_id;                              
                            $oexe1 = mysqli_query( $con, $osql1 );
                            $row1= mysqli_fetch_assoc( $oexe1 );
                            echo $row1['location']; ?></td>
