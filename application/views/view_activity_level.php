      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/activity_level'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Activity Level Details</h4>
         ...
         <div class="table-responsive">
            <table class="table mb-0">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php echo $games_level_id;?></td>
                  <td class="text-center"><?php echo $level;?></td>
                    <td class="text-center"><?php echo $session;?></td>
