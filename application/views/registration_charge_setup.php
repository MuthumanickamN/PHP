                    ...
                    <div class="form-group lg">
                     ...
                     <div class="form-group lg-btm">
                      <div class="col-md-6 control text-center">
                         <?php if($note=="") { ?>
                         <input id="save" type="submit" name="submit" value="Submit" class="btn btn-secondary" onclick="<?php echo base_url('index.php/registration_charge_setup/add/'); ?>"       class="btn btn-success" /> 
                       <?php } else { ?>
                          
                                     <input id="save" type="submit" name="submit" value="Update" class="btn btn-secondary" onclick="<?php echo base_url('index.php/registration_charge_setup/add/'); ?>"       class="btn btn-success" /><?php } ?>
                         ...
                         <a href="<?php echo base_url().'index.php/registration_charge_setup' ?>"     class="btn btn-secondary" >Cancel</a></div></div>
