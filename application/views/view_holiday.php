      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/set_academy_holiday'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Academy Holiday Details</h4>
            ...
            <table class="table mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $holiday_name;?></td>
                    <td class="text-center"> <?php echo date("d-m-Y-h-i-s", strtotime("$select_date")); ?></td>
