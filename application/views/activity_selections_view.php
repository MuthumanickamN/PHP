      ...
      <div class="">
        <form id="addContractForm" class="form-horizontal"  name="addContractForm" method="POST" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="col-md-2"> 
                <input type="number" id="contract_amount" name="contract_amount"  class="form-control"  value="0" >
          ...
          <div class="row">
            ...
            <div class="col-md-2"> 
                <input type="text" id="vat_amount" name="vat_amount"  class="form-control"  value="<?php echo 0.00; ?>" readonly>
          ...
          <div class="row">
            ...
            <div class="col-md-2"> 
                <input type="text" id="tot_amount" name="tot_amount"  class="form-control" value="0.00" readonly>
                <input type="hidden" id="hid_tot_amount" name="hid_tot_amount"  class="form-control" value="0.00" readonly>
...
<script type="text/javascript">
  ...
  $( document ).ready(function() {
	...
	$(document).on("keyup","#contract_amount",function(){
	    var val = parseInt($('input[type=radio][name=contract_year]').val());
		var vat_perc = $('#vat_percentage').val();
		var contract_fee = $('#contract_amount').val();
