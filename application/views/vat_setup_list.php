...
<script type="text/javascript">
 ...
 function view_vat_setup(id)
{
    window.location='<?php echo site_url('vat_setup/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/vat_setup/add/'); ?>" class="btn btn-primary"   ><b>New VAT Setup</b></a></li>
          </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">VAT Setup List</h4>
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
								...
								<?php   
								$i=1;                     
								$osql1 = "select * from vat_setups ORDER BY id DESC"; 
								...
								<tr>
									...
									<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/vat_setup/edit/'.$row1['id']); ?>">
									</a>
									</td>

									<td style="text-align: center">
									<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/vat_setup/delete/'.$row1['id']); ?>">
									</a>
									</td>
								</tr>
								<?php  $i++; } ?>
