 ...
 function view_games(id)
{
    ...
    window.location='<?php echo site_url('index.php/registration_charge_setup/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/registration_charge_setup/add/'); ?>" class="btn btn-primary"   ><b>New Registration Charge</b></a></li>
          </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Registration Charge List</h4>
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                <thead>
                                    <tr>
										...
										<th style="text-align: center">Registration Fees(AED)</th>
										<th>Note</th>
                                ...
                                <tbody>
                                   <?php    
									$i=1;                    
									$osql1 = "select * from reg_charge_setups ORDER BY id DESC";
									...
									foreach($result as $row1)
									{
										...
										<tr>
											<td style="text-align: center"><?php echo $row1['category']; ?></td>
											<td style="text-align: center"><?php echo $row1['reg_fee']; ?></td>
											...
											<span style="display:none"><?php echo strtotime($date_time1);?></span>
												<?php if($date_time1=='0000-00-00 00:00:00') { echo '-'; } else  { echo date("d/m/Y H-i-s", strtotime("$date_time1")); } ?>
											</td>
											
											<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/registration_charge_setup/edit/'.$row1['id']); ?>">
											</a>
											</td>
											<td style="text-align: center">
											<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('index.php/registration_charge_setup/delete/'.$row1['id']); ?>">
											</a>
											</td>
										</tr>
							<?php $i++; } ?>
