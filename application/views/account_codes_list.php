...
<script type="text/javascript">
 ...
 function view_account_codes(id)
{
    
    window.location='<?php echo site_url('index.php/account_codes/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/account_codes/add/'); ?>" class="btn btn-primary"   ><b>New Activity Code</b></a></li>
          </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Account  Code List</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
							...
							<?php         
								$i=1;              
								$osql1 = "select * from account_codes ORDER BY id DESC"; 
							...
							?>
							<tr>
								<td><?php echo $row1['name_of_service']; ?></td>
								...
								<td style="text-align: center"><a type="button" style="color:green;text-decoration:none; line-height: 5px;" class="btn btn-successs" data-id="4" data-status="Active" data-toggle="tooltip" title="Currently Status Active &#xA;Click to Make Inactive">
								<div style="display: none;" class="active_sort" value="1">1</div>&nbsp;<?php echo $row1['status']; ?></a></td>
								<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/account_codes/edit/'.$row1['id']); ?>">
								</a></td>
							</tr>
							<?php  $i++; } ?>
