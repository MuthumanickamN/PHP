...
<script type="text/javascript">
 ...
 function view_location(location_id)
{
    window.location='<?php echo site_url('location/view/'); ?>'+location_id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('Location/add/'); ?>" class="btn btn-primary"   ><b>New Location</b></a></li>
          </ul>
        ...
        <div class="col-12">
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                ...
                                <tbody>
                                   <?php        $i=1;                
                          $osql1 = "select * from locations ORDER BY location_id DESC";                              
                            $oexe1 = $this->db->query($osql1 );
                             foreach ( $oexe1->result_array() as $key => $row1 ){  $date_time=$row1['created_at'];
            ...
            <tr>
                ...
                <!--<td style="text-align: center;"><?php if($date_time1=='0000-00-00 00:00:00') { echo '-'; } else  { echo date("d/m/y-h-i-s", strtotime("$date_time1")); } ?></td>
                  <td style="text-align: center"><a type="button" style="color:white;text-decoration:none" onClick="view_location(<?php echo $row1['location_id'];?>)" class="btn btn-info fa fa-eye" data-id="4" data-toggle="tooltip" title="View">
        <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>-->
                <td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('location/edit/'.$row1['location_id']); ?>">
        </a>
                    </td>

                <td style="text-align: center">
                    <a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('location/delete/'.$row1['location_id']); ?>">
        </a>
                  </td>
