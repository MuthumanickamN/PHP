      ...
      <div class="content-wrapper">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#"><?php echo ucfirst($from);?> Registration</a>
                  </li>
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('Coach'); ?>" class="btn btn-primary"   ><b>New <?php echo ucfirst($from);?></b></a></li>
          </ul>
