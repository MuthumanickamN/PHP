      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('index.php/Registration_Fees'); ?>" class="btn btn-primary"   ><b>Back</b></a></li>
          </ul>
...
<section id="configuration">
    ...
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Registration Fees Details</h4>
                ...
                <tr>
                  <th class="text-center">Reg-ID</th>
                   ...
                   <th class="text-center">Payment Type</th>
                    <th class="text-center">Paid Amount (AED) Including VAT</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $student_name;?></td>
                    <td class="text-center"><?php echo $parent_id;?></td>
                     <td class="text-center"><?php echo $parent_name;?></td>
                  <td class="text-center"><?php echo $parent_contact;?></td>
                    <td class="text-center"><?php echo $pay_type;?></td>
                     <td class="text-center"><?php echo $wallet_balance;?></td>
