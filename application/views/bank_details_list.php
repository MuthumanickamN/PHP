 ...
 function view_bank(id)
{
    ...
    window.location='<?php echo site_url('bank_details/view/'); ?>'+id; 
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-6 col-12">
            ...
            <li> <a href="<?php echo site_url('bank_details/add/'); ?>" class="btn btn-primary"   ><b>New Bank</b></a></li>
          </ul>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><b>Bank List</b></h4>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                ...
                                <tbody>
                                 <?php   
								 $i=1;                     
								 $osql1 = "select * from bank_details ORDER BY id DESC"; 
							...
							<tr>
								...
								<td><?php echo $row1['bank_location']; ?></td>
                <td><?php echo $row1['IBAN_No']; ?></td>
                <td><?php echo $row1['Account_No']; ?></td>
                <td><?php echo $row1['Swift_Code']; ?></td>
                <td><?php echo $row1['IFSC_Code']; ?></td>
								<td style="text-align: center">
									<span style="display:none"><?php echo strtotime($date_time);?></span><?php echo date("d/m/Y h-i-s", strtotime("$date_time")); ?>
								</td>
								<td style="text-align: center;">
									<span style="display:none"><?php echo strtotime($date_time1);?></span><?php if($date_time1=='0000-00-00 00:00:00') { echo '-'; } else  { echo date("d/m/Y h-i-s", strtotime("$date_time1")); } ?>
								</td>
								<td style="text-align: center"><a type="button" style="color:white;text-decoration:none; line-height: 15px" class="btn btn-warning fa fa-edit" data-id="4" data-toggle="tooltip" title="Edit" href="<?php echo base_url('bank_details/edit/'.$row1['id']); ?>">
								</a>
								</td>
								<td style="text-align: center">
								<a type="button" onClick="return confirm('Are you sure you want to delete?')" style="color:white;text-decoration:none; line-height: 15px;" class="btn btn-danger fa fa-trash" data-id="4" data-toggle="tooltip"  href="<?php echo base_url('bank_details/delete/'.$row1['id']); ?>">
								</a>
								</td>
							</tr>
							<?php $i++; } ?>
