...
<section id="configuration">
    <div class="row">
        ...
        <td align="center"><a type="button" style="color:white;text-decoration:none" onClick="view_admin(<?php echo $coach['admin_id'];?>, '<?php echo $from;?>' )" class="btn btn-info fa fa-eye" data-id="4" data-toggle="tooltip" title="View">
