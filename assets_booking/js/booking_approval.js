            ...
            success : function(data)
            {
              ...
              // alert(data);
                if(data != 'exist'){
                    ...
                    newdiv += "<div class='col-sm-12 col-md-12' id='hideMe'><div class='alert alert-danger'>";
                    newdiv += "<i class='fa fa-check-square' aria-hidden='true' style='color:#fff;'></i>"; 
                    newdiv += "<strong style='color:#fff;'>&nbsp;Sorry!, Already approved for this Booked Timeslot!</strong></div></div>";
                    $("#dynamic_message").after(newdiv);
                    $('#hideMe').delay(3000).fadeOut('slow');                      
                }
