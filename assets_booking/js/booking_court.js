...
function show_booking_timeslot(){
    ...
    events : base_url+'Booking_court/get_events/'+sports+'/'+location+'/'+parent_id,
...
function show_booking_timeslot_old(){
    ...
    if(sports !='' && location !='' && date !=''){
      //  clear_cart_history();
        $.ajax({ 	
            type: "POST",   
            url: base_url+"Booking_court/show_booking_timeslot",
...
function show_booking_cart_details(id, arraykey, fromtime, totime, date, btnid){    
   ...
   else
   {
    ...
    $.ajax({ 	
        type: "POST",   
        url: base_url+"Booking_court/show_timeslot_details",
...
function get_customerPenddingDeductableAmount(){
    ...
    $.ajax({ 	
        type: "POST",   
        url: base_url+"Booking_court/get_customerPendingDeductableAmount",
		data:{
			email:email
			},
        //data:"mob_no="+mob_no,		
...
function view_modal_popup(booked_slotid){
    ...
    $.ajax({ 	
        type: "POST",   
        url: base_url+"Booking_court/get_bookedslot_details",
...
function cancel_booking(customer_id,paid_amount,booking_id, bookingslot_id, remarks=''){
    ...
    $.ajax({ 	
        type: "POST",   
        url: base_url+"Booking_court/cancel_booking",
...
function getLocationNames(){
    ...
    if(selectedSports !='')
    {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"Booking_court/get_locationnames",
...
function addSlot(this_){
    ...
    jQuery.ajax({
        type:'POST',
        url:baseurl+'Booking_court/add_slot_booking',
        data:{
...
function remove_cart_item(id)
{
    $.ajax({ 	
        type: "POST",   
        url: base_url+"Booking_court/remove_cart_item",
        data:"id="+id,
        async: false,
        datatype: "html",
        success : function(data)
