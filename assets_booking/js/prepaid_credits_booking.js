...
jQuery.validator.addMethod('chk_mobile', function (value) {
       // var hid_id = $("#hidden_id").val();
        ...
        if(customer_mobile != ''){
            $.ajax({ 	
                    type: "POST",   
                    url: base_url+"prepaid_credits_booking/check_mobile_exist",
	...
	$('#fetch').click(function(){
       ...
       rules: {
		...
		submitHandler: function(form) {
			...
			$.ajax({
					     type:"POST",
					     url:base_url+"prepaid_credits_booking/search_email_check",
						 datatype:"json",
						 async:false,
						 data:{
							 email:email
...
function get_credit_member_list(){
    ...
    $.ajax({ 	
        type: "POST",   
        url: base_url+"prepaid_credits_booking/get_credit_member_list",
